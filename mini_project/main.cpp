...
void welcomeScreen()
{
    ...
    cout << "\t\t\t\t\t\t\t\t\t\t||                                            ||\n";
    cout << "\t\t\t\t\t\t\t\t\t\t||                    PROJECT                 ||\n";
    cout << "\t\t\t\t\t\t\t\t\t\t||        Developer : Vaibhav Singh Chauhan   ||\n";
    cout << "\t\t\t\t\t\t\t\t\t\t================================================\n\n\n";
...
void userMenu()
{
    ...
    while (1)
    {
        ...
        {
        case 1:
            ticketObj.bookTicket();
            system("pause");
            break;

        case 2:
            ticketObj.showTicketsByPNR();
            system("pause");
            break;
...
void viewBookingsMenu()
{
    ...
    while (1)
    {
        ...
        case 2:
            ticketObj.showTicketsByName();
            system("pause");
            break;

        case 3:
            ticketObj.showTicketsByBus();
            system("pause");
            break;

        case 4:
            ticketObj.showTicketsBySource();
            system("pause");
            break;

        case 5:
            ticketObj.showTicketsByDestination();
            system("pause");
            break;

        case 6:
            ticketObj.showAllTickets();
            system("pause");
            break;
